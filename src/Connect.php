...
class Connect {
    ...
    */
    ...
    /**
    * Decrypt a filtered key generated by the generateFilteredKey function
    * @param string $encryptedKey key returned by generateFilteredKey
    * @param string $masterKey The master key for the Connect project
    * @return String
    */
    public static function decryptFilteredKey($encryptedKey, $masterKey) {
        return Security::decryptFilteredKey($encryptedKey, $masterKey);
    }
